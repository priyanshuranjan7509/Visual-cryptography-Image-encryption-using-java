...
public void TRIPLE_DES_() throws IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
...
//			BufferedImage  redImg=null;
		    ...
		    cipher.init(Cipher.ENCRYPT_MODE,new SecretKeySpec(keyGenerator.generateKey().getEncoded(),"DESede"));
	       //BufferedImage.TYPE_4BYTE_ABGR
	        ...
	        // write output image
	        try {
			       f = new File("C:/Users/nr/Desktop/VisualCryptographyAssignment/CipherImages/TRIPLE_DESEncryptedImage.jpg");
